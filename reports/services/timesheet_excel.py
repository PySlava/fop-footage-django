...
def generate_timesheet_p5_xlsx(year=None, month=None, employees=None):
    ...
    fill_weekend = PatternFill(start_color="F2D7D5", end_color="F2D7D5", fill_type="solid") # Рожевий/сірий для вихідних
    ...
    for idx, emp in enumerate(employees, start=1):
        ...
        for day in range(1, days_in_month + 1):
            ...
            is_weekend = date_obj.weekday() in (5, 6) # 5 - Субота, 6 - Неділя
            ...
            if is_weekend:
                ...
                cell.value = "Р / 8" # 8 робочих годин
                total_days += 1
                total_hours += 8
